...
void main() {
  ...
  tes1(n != null && n > 0, () {
    int i = 0;
    // Menggunakan fungsi seperti while untuk menghasilkan angka acak tanpa mencetak setiap angka
    tes2(() => i < n!, () {
    ...
    // Cetak list angka acak setelah seluruh angka dihasilkan
    print('Angka acak: $randomNumbers');

    print('Pilih operasi yang ingin dilakukan:');
    print('1. Bubble Sort');
    print('2. Hitung Inversi & Balik Urutan Array');
    print('3. Shuffle (Acak Posisi Elemen)');
    print('4. Cetak Piramida');
    print('5. Piramida dalam Array');
...
// Fungsi untuk menghitung jumlah inversi menggunakan while
